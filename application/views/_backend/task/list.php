                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a href="https://www.google.com/maps/place/<?=$key->latitude?>+<?=$key->longitude?>" target="_BLANK">https://www.google.com/maps/place/<?=$key->latitude?>+<?=$key->longitude?></a>
                        </div>
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    ...
                                    <li>
                                        <a href="<?=base_url()?>assets/images/bukti/<?=$key->bukti_photo?>" target="_BLANK" class="tooltip-success" data-rel="tooltip" title="Lihat Bukti">
                                            <span class="green">
                                                <i class="ace-icon fa fa-search-plus bigger-120"></i>
                                            </span>
                                        </a>
                            ...
                            if ($this->userdata->user_status != "2") {
                                if ($key->status_sampah == "0"){ echo "Belum diambil."; }
                                    elseif ($key->status_sampah == "1"){
                                        ...
                                        echo "Sudah diambil oleh ".$oleh->Nama.".<br/>Pada tanggal ".date_format(date_create($oleh->tanggal_pengambilan), "d-M-Y H:i:s"); 
                                    }
                                    elseif ($key->status_sampah == "2"){ 
                                        $oleh = $this->db->select("concat_ws(' ', tb_members.Nama_Depan, tb_members.Nama_Belakang) AS Nama")
                                                         ...
                                                         ->where("tb_pengumpulansampah.id_sampah", $key->id_sampah)
                                                         ->get("tb_members, tb_pengumpulansampah, tb_pengambilansampah")->row();
                                        echo "Tidak ada, sudah diperiksa oleh ".$oleh->Nama.".<br/>Pada tanggal ".date_format(date_create($oleh->tanggal_pengambilan), "d-M-Y H:i:s"); 
                                    }
