<?=@$this->session->flashdata("msg")?>
	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" action="<?=base_url()?>Redaktur/Carousel/prosesadd" method="POST" enctype="multipart/form-data">
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left"> Caption </label>

				<div class="col-sm-10">
					<input type="text" placeholder="Caption" class="form-control" name="carousel_caption" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="carousel_deskripsi" name="carousel_deskripsi"></textarea>
				</div>
			</div>
